...
export const layout = {
  ...
  */
  ...
  /*
    Насколько плита ужимается при скролле.

    Было 0.36 — плита падала до 0.64 и переставала читаться: план превращался
    в марку, а место под ним всё равно не освобождалось (масштаб трансформом,
    высота зарезервирована). Теперь освобождается — вкладки идут по
    ИЗМЕРЕННОМУ краю плиты, — и глубину можно держать щадящей: 0.2 отдаёт
    пятую часть высоты, а комната на кадре остаётся узнаваемой и на телефоне,
    и на планшете.
  */
  planShrink: 0.2,
  planShrinkStart: 24,
