 ...
 */
/**
 * МОЙ НОМЕР — КРОВАТЬ, А НЕ ДОМИК.
 *
 * Здесь стоял тот же дом, что у «Главной»: средний путь `M6 10v9h12v-9`
 * совпадал ДОСЛОВНО, крыша и дверь отличались парой координат. В ряду из шести
 * вкладок две одинаковые картинки — это не мелочь оформления: гость целится в
 * «Номер» и попадает на «Главную», потому что различает вкладки по силуэту, а
 * не по подписи в восемь пикселей.
 *
 * Кровать: изголовье, матрас с изножьем, подушка. Один штрих, сетка 24×24 —
 * как у остальных.
 */
