...
PHOTOS: dict[str, tuple[str, str, str]] = {
    ...
    # Каждый снимок проверен глазами перед тем, как попасть сюда: ключ без
    # проверки — это следующая «фотография бара на разделе об отеле».
    "airport-pickup": ("1436491865332-7a61a109cc05", "Ross Parmly", "Трансфер из аэропорта"),
    "airport-dropoff": ("1570710891163-6d3b5c47248b", "Ashim D’Silva", "Трансфер в аэропорт"),
    "city-tour": ("1533105079780-92b9be482077", "Johnny Africa", "Экскурсии"),
    "car-rental": ("1493238792000-8113da705763", "Alex Suprun", "Аренда автомобиля"),
    "table-booking": ("1414235077428-338989a2e8c0", "Jay Wennington", "Бронирование ресторана"),
    "tickets": ("1503095396549-807759245b35", "Kilyan Sockalingum", "Билеты"),
    "flowers": ("1487070183336-b863922373d4", "Alisa Anton", "Доставка цветов"),
    "babysitter": ("1476703993599-0035a21b17a9", "Alexander Dummer", "Няня"),
    "laundry-service": ("1545173168-9f1947eebb7f", "Jeremy Sallee", "Прачечная и глажка"),
    ...
    # Вывеска отеля, а не шезлонги на пляже: консьерж — это услуги ОТЕЛЯ, и
    # пляжный кадр здесь читался как «ещё один бассейн».
    "venue-concierge": ("1517840901100-8179e982acb7", "Marten Bjork", "Консьерж"),
