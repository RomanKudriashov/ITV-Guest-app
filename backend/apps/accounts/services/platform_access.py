...
каждого тенанта. Поэтому к обычной аутентификации добавлены два независимых
рубежа: откуда пришли (allowlist) и чем подтвердили себя (2FA, см. totp.py).

Оба рубежа не заменяют существующую авторизацию, а надстраиваются над ней —
