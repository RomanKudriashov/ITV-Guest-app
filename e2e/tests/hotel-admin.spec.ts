 ...
 *
 * Definition of Done прогона: номер + печатный QR (ведёт на рабочий /r/:room),
...
test.describe('Админка отеля', () => {
  ...
  test('созданного сотрудника можно выбрать в персональном канале (пробел прогона 6)', async ({
    page,
    request,
  }) => {
