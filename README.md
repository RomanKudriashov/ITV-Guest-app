...
> **Статус: фундамент + CMS «Меню».** Собран каркас, на который ложатся
> вертикальные срезы, и первый рабочий раздел админки — каталог еды
> (категории, блюда, модификаторы, фото, расписания). Витрина гостя и трекер
> персонала — следующие прогоны; от гостевой части есть только дымовые
...
* Витрина гостя и трекер персонала — следующие прогоны.
...
* Функциональный WS-трекер (действия, назначение, SLA).
