...
> **Статус: срез «еда» замкнут end-to-end.** Гость заказывает с телефона →
> заказ в реальном времени появляется на доске кухни → повар принимает и
> ведёт его по статусам → гость видит это у себя, не перезагружая страницу.
> Есть каркас, CMS-раздел «Меню», гостевая витрина и трекер кухни.
