...
## Маркетинговые бейджи в позиции (A3+ шаг 3)
...
## Стартовая: активные заказы и быстрые действия (A3+ шаг 4)
...
Полоса живёт вживую по **реконсиляции снимком** (паттерн прогона 3): фронт
